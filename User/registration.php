...
<html lang="en">
  ...
  <body>
     ...
     <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasSearch">
      ...
      <div class="offcanvas-body">
        <div class="order-md-last">
          ...
          <form id="search-form" action="../index.html" method="post" class="d-flex mt-3 gap-0">
      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="search-bar row bg-light mt-3 rounded-4 pb-3 pt-2 p-3">
            <div class="order-md-last">
              <form role="search" action="../index.html" method="post" class="d-flex mt-2 gap-0 ">
                <input class="form-control rounded-start rounded-0 bg-light" type="text" placeholder="What are you looking for?" aria-label="What are you looking for?">
                <div class="col-3">
            ...
            <ul class="d-flex justify-content-end list-unstyled mx-2 mb-1 ">
              ...
              <li class="nav-item dropdown mb-1">
                  <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <img class="wd-35 ht-35 rounded-circle" src="https://via.placeholder.com/40x40
                      " alt="profile">
                  </a>
                  <div class="dropdown-menu p-3 mx-2" aria-labelledby="profileDropdown">
                      <div class="d-flex flex-column align-items-center border-bottom px-3 py-3">
                          <div class="mb-3">
                              ...
                              <img class="wd-50 ht-50 rounded-circle" src="https://via.placeholder.com/120x120" alt="">
                          </div>
    ...
    <div class="success-container">
         <p class="success-message"><?php B_register(); ?></p> <!-- message when you success Register -->
    </div>
    <style>
      .success-container {
            ...
            margin-bottom: 15px; /* Optional: Add some space at the bottom */
            margin-right: 400px;
            margin-left: 400px;
        }
    ...
    <div class="container">
      ...
      <div class="content">
        <form action="" method="post" name="signupForm" id="signupForm">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <div class="password-container">
                ...
                <span class="eye-icon" onclick="toggle()">
            ...
            <div class="input-box">
              ...
              <div class="password-container">
                ...
                <span class="eye-icon" onclick="toggle1()">
          ...
          <div class="button">
            <input type="submit" name="submit" onclick="validatePassword()" id="submitButton" value="Register">
            <span id="loader"></span>
          </div>
        </form>
      </div>
    ...
    <script>
          ...
          document.getElementById('signupLogo').src = "../images/APZShop_photo.png";
          enableSubmitButton();
