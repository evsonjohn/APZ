          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                  <form acction="" method="post">
                    <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                      ...
                      <button type="button" class="btn  btn-floating mx-1 btn-facebook">
                        <i class="fab fa-facebook-f"></i>
                      </button>
                      
                      <button type="button" class="btn  btn-floating mx-1 btn-google">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="form-check mb-0">
                        <input class="form-check-input-dark me-2" type="checkbox" value="" id="form2Example3" />
                        <label class="form-check-label dark-form-check-label" for="form2Example3">
                          Remember me
                        </label>
                      </div>
